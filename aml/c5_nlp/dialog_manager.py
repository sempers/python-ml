...
class ThreadRanker(object):
    ...
    def load_tag_name(self, tag_name):
        return self.__load_embeddings_by_tag(tag_name)

    def get_best_thread(self, question, tag_name):
        thread_ids, thread_embeddings = self.__load_embeddings_by_tag(tag_name) #works       
